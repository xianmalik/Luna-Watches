...
import { PAYMENT_METHODS, BANK_TRANSFER_DETAILS } from "@/lib/app.settings";
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-neutral-500 mt-1">{method.description}</div>
                </div>
              </div>
              ...
              {isSelected && method.id === "bank" && (
                <div className="mt-4 pt-4 border-t text-sm text-neutral-600 space-y-2">
                  ...
                  <div className="bg-neutral-50 p-3 rounded space-y-1 text-xs">
                    <p><span className="font-medium">Bank:</span> {BANK_TRANSFER_DETAILS.bank}</p>
                    <p><span className="font-medium">Account Name:</span> {BANK_TRANSFER_DETAILS.accountName}</p>
                    <p><span className="font-medium">Account Number:</span> {BANK_TRANSFER_DETAILS.accountNumber}</p>
                    <p><span className="font-medium">SWIFT Code:</span> {BANK_TRANSFER_DETAILS.swiftCode}</p>
                  </div>
